...
const nextConfig: NextConfig = {
  ...
  outputFileTracingIncludes: {
    "/api/projects/[slug]/*": [
      ...
      // Read at runtime for deterministic (non-LLM) answers, via a path built
      // from the project folder -- not something the file tracer can follow.
      "./uk-parliament-project/output/uk_constituencies.json",
    ],
  },
};
